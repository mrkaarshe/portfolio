  ...
  return (
    <div id="about" data-aos="fade-up" className=" mb-1 mt-20 max-w-7xl mx-auto   rounded-4xl  p-5  ">
      ...
      <div   className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3    ">
         <div data-aos="fade-right" className=" bg-gradient-to-t from-slate-950/30 to-slate-900/10 relative rounded-3xl">
           <img src={profile} className="w-100 h-100 sm:w-84 sm:h-70  object-center bg-cover bg-center "  alt="potfolio-image" />
           <div className="absolute w-full h-1/6 blur-sm bg-slate-900/20 rounded-3xl  bottom-0"></div>
